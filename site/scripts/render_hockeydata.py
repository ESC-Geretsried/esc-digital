...
<section class="team-section" id="mannschaft"><div class="shell"><p class="eyebrow">Mannschaft</p><h2>Aktueller Kader</h2>{''.join(roster_html)}<div class="roster-group"><h3>Trainer & Team hinter dem Team</h3><div class="staff-grid">{staff_html}</div></div><p class="team-source-note">Kader und Betreuung der River Rats. Spielerfotos werden angezeigt, wenn ein passendes Bild vorliegt.</p></div></section>
